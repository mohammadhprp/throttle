...
type HealthCheckResponse struct {
	state         protoimpl.MessageState            `protogen:"open.v1"`
	Status        HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=throttle.v1.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_health_proto_rawDesc = "" +
	"\n" +
	"\x12proto/health.proto\x12\vthrottle.v1\".\n" +
	"\x12HealthCheckRequest\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\"\xae\x01\n" +
	"\x13HealthCheckResponse\x12F\n" +
	"\x06status\x18\x01 \x01(\x0e2..throttle.v1.HealthCheckResponse.ServingStatusR\x06status\"O\n" +
	"\rServingStatus\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aSERVING\x10\x01\x12\x0f\n" +
	"\vNOT_SERVING\x10\x02\x12\x13\n" +
	"\x0fSERVICE_UNKNOWN\x10\x032\xa2\x01\n" +
	"\x06Health\x12J\n" +
	"\x05Check\x12\x1f.throttle.v1.HealthCheckRequest\x1a .throttle.v1.HealthCheckResponse\x12L\n" +
	"\x05Watch\x12\x1f.throttle.v1.HealthCheckRequest\x1a .throttle.v1.HealthCheckResponse0\x01B(Z&github.com/mohammadhprp/throttle/protob\x06proto3"
...
var file_proto_health_proto_goTypes = []any{
	(HealthCheckResponse_ServingStatus)(0), // 0: throttle.v1.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: throttle.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: throttle.v1.HealthCheckResponse
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: throttle.v1.HealthCheckResponse.status:type_name -> throttle.v1.HealthCheckResponse.ServingStatus
	1, // 1: throttle.v1.Health.Check:input_type -> throttle.v1.HealthCheckRequest
	1, // 2: throttle.v1.Health.Watch:input_type -> throttle.v1.HealthCheckRequest
	2, // 3: throttle.v1.Health.Check:output_type -> throttle.v1.HealthCheckResponse
	2, // 4: throttle.v1.Health.Watch:output_type -> throttle.v1.HealthCheckResponse
